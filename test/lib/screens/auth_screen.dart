...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      if (_isLogin) {
        try {
          // First try regular Firebase Auth
          await FirebaseAuth.instance.signInWithEmailAndPassword(
            email: _emailController.text.trim(),
            password: _passwordController.text,
          );
        } catch (e) {
          print('Firebase Auth Login Error: ${e.toString()}');
          
          // If that fails, check our custom Firestore auth
          ...
          try {
            ...
            // Check if password matches (in a real app this would use proper hashing)
            ...
            // If credentials match, set up our dummy auth with the user data
            ...
            print('Successfully logged in with alternate auth method');
          } catch (customAuthError) {
            // If custom auth also fails, rethrow the error
            print('Custom auth login failed: $customAuthError');
            rethrow;
          }
        }
      } else {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Score your bridge games with ease\nTrack points and manage teams',
                      style: TextStyle(
